...
y = np.loadtxt('Data_st\\545110-99999.csv',delimiter=',')[:2922,0]
loss_y = np.isnan(y)
y[loss_y]=0
...
y_true = np.loadtxt('Data_st\\545110-99999.csv',delimiter=',')[2928:3750,0]

np.savetxt('y_true.csv',y_true,delimiter=',')
np.savetxt('y.csv',y,delimiter=',')
np.savetxt('y_day_average.csv',y_day_average,delimiter=',')